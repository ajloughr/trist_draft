...
docker exec -i django-test python scripts/clean_csv.py /code/draft_data/TRIST_Database_2026_v4.csv /code/draft_data/TRIST_Database_2026_v4_clean.csv

echo "Importing NFL players..."
docker exec -i django-postgres-test psql -U postgres -d test_db -c "COPY auction_table_nfl_player(player_id,full_name,team_short_name,team,bye,position,salary,final_year,drafted_by) FROM '/home/draft_data/TRIST_Database_2026_v4_clean.csv' DELIMITER ',' CSV HEADER;"
